...
void update_mario_geometry_inputs(struct MarioState *m) {
    ...
    f32_find_wall_collision(&m->pos[0], &m->pos[1], &m->pos[2], 65.0f, 30.0f); // old: 60.0f, 50.0f
    //f32_find_wall_collision(&m->pos[0], &m->pos[1], &m->pos[2], 30.0f, 24.0f); // lower wall (won't use this)
